    ...
    <div className="flex flex-col items-center py-10 px-4">
      ...
      <div className="w-full max-w-4xl  bg-gradient-to-br from-soft-clay to-stone-600 text-gray-800 rounded-3xl p-6 mb-10">
        ...
        <p className="text-sm leading-relaxed">
          ...
          gradients, stars, planets, and wind into a single dynamic environment.
          It represents the core idea of this showcase: pushing frontend
          techniques beyond isolated demos into a cohesive, responsive visual
          system.
        </p>
      </div>
      ...
      <div className="w-full max-w-4xl text-gray-800 rounded-3xl p-6 mb-10 bg-gradient-to-br from-soft-clay to-stone-600">
        ...
        <p className="text-sm leading-relaxed mb-4">
          ...
          in real time. Weather data from the OpenWeather API is translated into
          hand‑drawn skies, rain, snow, and wind — each effect layered together
          to create a living illustration of the world outside. This isn’t just
          a forecast; it’s a visual story that changes minute by minute with the
          atmosphere.
        </p>
        <p className="text-sm leading-relaxed mb-6">
          Select your location below to see the canvas breathe with your city’s
          weather.
        </p>
      ...
      <div className="w-full max-w-4xl  bg-gradient-to-br from-soft-clay to-stone-600 text-gray-800 rounded-lg p-6 mb-10">
        <h2 className="text-2xl font-bold mb-4">Technical Showcase Overview</h2>
        <p className="text-sm leading-relaxed mb-2">
          Each visual effect in this gallery is not just aesthetic—it
          demonstrates distinct engineering patterns in React and Tailwind CSS.
        </p>
        <ul className="list-disc list-inside text-sm space-y-2">
          <li>
            <strong>Rain:</strong> Raindrops styled in <code>globals.css</code>,
            generated via <code>generateRaindrop</code>, each using{" "}
            <code>useState</code> +<code>useEffect</code> with staggered timers
            and keyframe classes (<code>animate-rain-animation-*</code>) to
            avoid uniform lines.
          </li>
          <li>
          ...
          <li>
            ...
            gradient strings indexed by the current hour, updated via props and
            smoothed with
            <code>transition-colors</code> for an elegant day/night illusion.
          </li>
          <li>
            <strong>Stars & Planets:</strong> Stars generated globally and
            passed as props into <code>StarField</code> (state-driven twinkle),
            while planets are memoized with <code>useMemo</code> and animated
            with orbital keyframes.
          </li>
          <li>
        ...
        <p className="text-sm mt-4">
          Together these effects illustrate how hooks, props, global utilities,
          and custom Tailwind animations combine to produce naturalistic motion
          and responsive visual systems.
        </p>
      </div>
